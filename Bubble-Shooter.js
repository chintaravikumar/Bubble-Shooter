...
window.onload = function() {
    ...
    function drawFrame() {
        ...
        // Draw title
	context.fillStyle = "#beebdf"; // Set text color
context.font = "bold 23px 'Poppins', sans-serif"; // Improved font style
context.fillText("BUBBLE SHOOTER", 205, 37);

// Draw underline
context.beginPath();
context.strokeStyle = "#beebdf"; // Match text color
context.lineWidth = 2;
context.moveTo(205, 40);  // Start position of underline
context.lineTo(421, 40);  // End position of underline (adjust as needed)
context.stroke();
        ...
        context.fillText("~ Created By Ravi " , 475, 73);
